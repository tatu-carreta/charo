...
<body class="interiores">
	...
	<section>
		<div class="container">
			...
			<h3>Agregar (o editar) grupo de fotos</h3>
			<form class="form-admin">
				<label>
					<h4><span>1</span>Ingrese un título para este grupo de fotos</h4>
					<input type="text" class="campo-form">
				</label>
				<div class="botones-guardar">
					<input type="submit" id="" value="Guardar" class="btn btn-azul">
